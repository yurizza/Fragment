...
public class detailPahlawan extends AppCompatActivity {
    ...
    private TextView tvPahlawan,tvDetailPahlawan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivPahlawan = findViewById(R.id.ivPahlawan);
        tvPahlawan = findViewById(R.id.tvPahlawan);
        tvDetailPahlawan = findViewById(R.id.tvDetailPahlawan);

        String namaPahlawan = getIntent().getStringExtra("nama");
        int id = getIntent().getIntExtra("id",0);

        ivPahlawan.setImageResource(heroesImages[id]);
        tvPahlawan.setText(namaPahlawan);
        tvDetailPahlawan.setText(heroDetails[id]);
    }
}
